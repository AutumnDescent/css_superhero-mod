...
def player_footstep(ev):
    ...
    if superhero.hasHero(userid,'Invisible Man'):
        ...
        superhero.Users[userid]['oldpos'] = es.getplayerlocation(userid)
        if a != 255:
    ...
    for userid in superhero.Users:
        ...
        if superhero.hasHero(userid,'Invisible Man'):   
            ...
            if not playerlib.getPlayer(userid).isdead:
                if not 'oldpos' in superhero.Users[userid]: superhero.Users[userid]['oldpos'] = 0
                newpos = es.getplayerlocation(userid)
                oldpos = superhero.Users[userid]['oldpos']
                ...
                superhero.Users[userid]['oldpos'] = newpos   
